...
class TrafficLightController:
    ...
    def _initialize(self):
        ...
        model_path = os.path.join(project_root, 'traffic_light_ai_project/ml_model', 'traffic_light_model.pth')
        ...
        scenarios_file_path = os.path.join(project_root, 'traffic_light_ai_project/data', 'simulation_scenarios.json')
